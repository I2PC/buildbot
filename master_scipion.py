...
def installSDevelScipionFactory(groupId):
    ...
    installXmippCmd = 'rm -rf scipion-em-xmipp && git clone https://github.com/I2PC/scipion-em-xmipp.git && cd scipion-em-xmipp && git checkout devel && cd .. && ./scipion3 installp -p ./scipion-em-xmipp --noBin --devel && ./scipion3 installb xmippDev'
